...
<div style="padding:10px; background:rgba(0,0,0,.7);">
	<span style="text-transform:uppercase; color:#FFF;">selecciona un calibre para renombrarlo</span>
    <button onclick="actualizarCalibres()" style="width:200px; float:right; margin-top:-5px;">ACTUALIZAR</button>
</div>
<div>
    <div style="width:50%; float:left;">
		...
		?>
        <select name="selBrand" id="selBrand" style="padding:10px; font-size:18px; width:99%; text-align:center; margin:5px 2px; text-transform:uppercase;" onchange="reemplazarSelect()">
...
<?php }else{ ?>
<div style="padding:10px; background:rgba(0,0,0,.7);">
	<span style="text-transform:uppercase; color:#FFF;">selecciona un calibre para eliminarlo</span>
    <button onclick="borrarCalibre()" style="width:200px; float:right; margin-top:-5px;">BORRAR CALIBRE</button>
</div>
<div>
    <div style="width:50%; float:left;">
        <?php 
