        ...
        <div class="panel-body">
            <form class="form-inline" role="form" method="post">
                ...
                <div class="form-group pad5-tb width100">
                    ...
                    <input type="password" class="form-control width100" required name="password_login" id="password_login" placeholder="<?php echo $translator->getText('LOGIN_PAGE_PLACEHOLDER_PASS'); ?>">
                </div>
