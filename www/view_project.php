...
<div class="text-right">
    <div class="btn-group" role="group">
        ...
        <button type="button" class="btn btn-danger" onclick="showAlertDelete('<?php echo $project->getNombre(); ?>', '<?php echo $project->getId_proyecto(); ?>', '<?php echo _ROOT_PATH_ . 'user-panel/delete-project' ?>')"><?php echo Translator::getTextStatic('GENERIC_DELETE'); ?></button>
    </div>
</div>
<?php
